-- TEMP verification: gateless copy of admin_store_snapshot (0017 self-dropped it,
-- so recreate here). Dropped by 0021 once aggregates are validated.
create or replace function public.admin_store_snapshot_test()
returns table (
  id uuid,
  business_name text,
  revenue_30d numeric,
...
$$;
grant execute on function public.admin_store_snapshot_test() to authenticated;
